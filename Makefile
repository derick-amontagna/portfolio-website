...
app-dry:
	export DEBUG=true; export LOGLEVEL=DEBUG; poetry run python index.py
...
pytest:
	poetry run pytest --no-cov-on-fail --cov-fail-under=70 --cov-branch --cov-report=term --cov-report=html:htmlcov --cov=backend
